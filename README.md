...
1. Improve the overall classification accuracy of this script, you are welcome to do this through better modelling, data processing or both. 80% or more overall classification accuracy is considered a strong result work.
...
Betas: we use a GLM to see how well voxel activity is modelled by a HRF, the value of the betas is indicative of this. You can think of the betas for a given trial as “the” cortical activation for this trial.
